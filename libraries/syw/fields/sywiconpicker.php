...
// 			}
			...
			$this->buttonrole = isset($this->element['buttonrole']) ? JText::_((string)$this->element['buttonrole']) : 'default';
			$this->buttonlabel = isset($this->element['buttonlabel']) ? JText::_((string)$this->element['buttonlabel']) : ($this->buttonrole == 'clear' ? JText::_('JCLEAR') : JText::_('JDEFAULT'));
