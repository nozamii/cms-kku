        ...
        <div class="registration<?php echo $this->pageclass_sfx ?>">
          ...
          <form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
            ...
            <?php foreach ($this->form->getFieldsets() as $fieldset):// Iterate through the form fieldsets and display each one.?>
              ...
              <div class="form-group">
                <button type="submit" class="button button-2 validate">
            ...
            <p>
              <?php echo JTEXT::_('G5_ALREADY_ACCOUNT'); ?> <a href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>"><?php echo JText::_('G5_LOGIN'); ?></a>
            </p>
          </div>
        </div>
      </div>
