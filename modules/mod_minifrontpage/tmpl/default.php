...
use Joomla\Module\Minifrontpage\Site\Helper\MinifrontpageHelper;
    ...
    <?php 
            ...
            foreach ($list as $item) : 
                ...
                <?php } else {
                    ...
                    $moreitem .= '<li><a href="'.$item->link.'" itemprop="url">'.JHtmlString::truncate(strip_tags($item->title), $title_truncate).'</a><span class="mfp_date">'.JHtml::_('date',$orderingdate, JText::_($date_format)).'</span></li>';
                }  
            $n++;
        endforeach; ?>
        <?php 
