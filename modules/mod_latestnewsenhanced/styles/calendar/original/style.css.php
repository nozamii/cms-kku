...
<?php endif; ?>
	...
	<?php echo $suffix; ?> .newshead .calendar.noimage {			
		...
		html[dir="rtl"] <?php echo $suffix; ?> .newshead .calendar .weekday {
			text-indent: -0.4em;
		}
		...
		html[dir="rtl"] <?php echo $suffix; ?> .newshead .calendar .month {
			text-indent: -0.45em;
		}
		...
		html[dir="rtl"] <?php echo $suffix; ?> .newshead .calendar .day {
			text-indent: -0.1em;
		}
