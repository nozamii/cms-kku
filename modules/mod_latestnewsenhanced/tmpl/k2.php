...
<?php else : ?>
	<?php
		$categories = modLatestNewsEnhancedHelperK2::getCategoryList($params, $list);
									...
									<div class="newshead calendartype">
										<?php if ($item->calendar_date) : ?>
											<div class="calendar <?php echo $extracalendarclass; ?>">
												<?php $date_params = modLatestNewsEnhancedCalendarHelper::getCalendarBlockData($params, $item->calendar_date, true); ?>
