...
class JFormFieldAssets extends JFormField {
	...
	public function renderField($options = array()) {
		...
		$doc->addStyleSheet(JUri::root()."modules/mod_easy_fbsharebutton/assets/css/modStyler.css");
		$doc->addScript(JUri::root()."modules/mod_easy_fbsharebutton/assets/js/modStyler.js");
