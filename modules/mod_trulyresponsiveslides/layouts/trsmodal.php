...
$title = isset($displayData['title']) ? $displayData['title'] : Text::_('MOD_TRULYRESPONSIVESLIDER_MODAL_TITLE');
	...
	<div id="<?php echo $selector; ?>" class="puremodal" role="dialog" aria-hidden="true">
		<div class="puremodal-content" aria-modal="true" aria-labelledby="<?php echo $selector; ?>Label">
			...
			<div class="puremodal-footer">
            	<button class="puremodal-close" aria-hidden="true"><?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?></button>
            </div>
		</div>
	</div>
<?php endif; ?>
<?php if ($bootstrapVersion == 2) : ?>
	<div id="<?php echo $selector; ?>" data-backdrop="false" data-keyboard="true" data-remote="true" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="<?php echo $selector; ?>Label" aria-hidden="true">
    	...
    	<div class="modal-footer">
    		<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?></button>
    	</div>
    </div>
<?php endif; ?>
<?php if ($bootstrapVersion > 2) : ?>
    		...
    		<div class="modal-content">
            	<div class="modal-header">
            		<?php if ($bootstrapVersion == 3) : ?>
            			<button type="button" class="close" data-dismiss="modal" aria-label="<?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?>"><span aria-hidden="true">&times;</span></button>
            	...
            	<div class="modal-footer">
            		<button class="btn btn-secondary" data-dismiss="modal" aria-hidden="true"><?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?></button>
            	</div>
    		</div>
    	</div>
    </div>
